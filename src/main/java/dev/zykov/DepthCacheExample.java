...
public class DepthCacheExample {
    ...
    public DepthCacheExample(String symbol) {
        ...
        BinanceApiClientFactory factory = BinanceApiClientFactory.newInstance(DomainType.Com);
        this.wsClient = factory.newWebSocketClient(DomainType.Com);
        this.restClient = factory.newRestClient(DomainType.Com);
